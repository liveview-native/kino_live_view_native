defmodule ServerWeb.MixProject do
  ...
  defp deps do
    [
      ...
      {:live_view_native_swiftui, github: "liveview-native/liveview-client-swiftui", branch: "main", override: true},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind server_web", "esbuild server_web"],
      "assets.deploy": [
        "tailwind server_web --minify",
        "esbuild server_web --minify",
        "phx.digest"
      ]
    ]
  end
